...
class Reponse
{
    ...
    #[Assert\NotBlank(message: 'La réponse ne peut pas être vide')]  // Contrôle pour ne pas être vide
    #[Assert\Length(min: 3, minMessage: 'La réponse doit contenir au moins {{ limit }} caractères')]  // Contrôle de longueur minimum
