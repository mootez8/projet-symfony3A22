...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AvatarController' => 'getAvatarControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.profile_images' => 'getSmartUniqueNamer_ProfileImagesService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('v3ec06twOG', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('244MgYENN2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QbcOGdYf8u', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5MBxMNlx9u', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['D:\\pidev-user\\src\\Entity'], true)), 'App\\Entity');
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AvatarController', 'App\\Controller\\DashboardController', 'App\\Controller\\HomeController', 'App\\Controller\\ProfileController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ResetPasswordController', 'App\\Controller\\SecurityController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'D:\\pidev-user/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('D:\\pidev-user/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['D:\\pidev-user\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'D:\\pidev-user\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => ''], 'D:\\pidev-user', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2UbX-pcxlR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Q4c9zhLoOh', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('63+FMRZLdn', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t7Sgs4jvdD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Q-KgI7+tFH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O3ZnMaHfWz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jju7I4EBAa', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'D:\\pidev-user', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\BanVoter'] ?? $container->load('getBanVoterService'));
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.profile_images' => ['privates', 'vich_uploader.listener.clean.profile_images', 'getVichUploader_Listener_Clean_ProfileImagesService', true],
            'vich_uploader.listener.remove.profile_images' => ['privates', 'vich_uploader.listener.remove.profile_images', 'getVichUploader_Listener_Remove_ProfileImagesService', true],
            'vich_uploader.listener.upload.profile_images' => ['privates', 'vich_uploader.listener.upload.profile_images', 'getVichUploader_Listener_Upload_ProfileImagesService', true],
        ], [
            ...
            'vich_uploader.listener.clean.profile_images' => '?',
            'vich_uploader.listener.remove.profile_images' => '?',
            'vich_uploader.listener.upload.profile_images' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.profile_images'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['preRemove'], 'vich_uploader.listener.remove.profile_images'], [['postFlush'], 'vich_uploader.listener.remove.profile_images'], [['prePersist'], 'vich_uploader.listener.upload.profile_images'], [['preUpdate'], 'vich_uploader.listener.upload.profile_images']]);
    }
    ...
    {
        $container->privates['doctrine.orm.default_xml_metadata_driver'] = $instance = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(['D:\\pidev-user\\vendor\\vich\\uploader-bundle\\config\\doctrine' => 'Vich\\UploaderBundle\\Entity'], '.orm.xml', true);
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), 'D:\\pidev-user', true);
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['D:\\pidev-user\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'D:\\pidev-user\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'D:\\pidev-user\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['D:\\pidev-user\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'D:\\pidev-user\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'D:\\pidev-user\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 'D:\\pidev-user\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ar.xlf', 'D:\\pidev-user\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ar.xliff', 'D:\\pidev-user\\vendor\\vich\\uploader-bundle/translations\\messages.ar.yaml'], 'az' => ['D:\\pidev-user\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'D:\\pidev-user\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'D:\\pidev-user\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['D:\\pidev-user\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'D:\\pidev-user\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'D:\\pidev-user\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['D:\\pidev-user\\vendor\\symfony\\validator/Resources/translations\\validators
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'D:\\pidev-user');
        $a->addPath('D:\\pidev-user\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('D:\\pidev-user\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('D:\\pidev-user\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('D:\\pidev-user\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('D:\\pidev-user\\vendor\\knplabs\\knp-paginator-bundle/templates', 'KnpPaginator');
        $a->addPath('D:\\pidev-user\\vendor\\knplabs\\knp-paginator-bundle/templates', '!KnpPaginator');
        $a->addPath('D:\\pidev-user\\vendor\\vich\\uploader-bundle/templates', 'VichUploader');
        $a->addPath('D:\\pidev-user\\vendor\\vich\\uploader-bundle/templates', '!VichUploader');
        $a->addPath('D:\\pidev-user/templates');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('D:\\pidev-user\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'D:\\pidev-user', 'UTF-8'));
        ...
        $instance->addExtension(new \App\Twig\AvatarExtension());
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['D:\\pidev-user\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'D:\\pidev-user',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'SymfonyCastsVerifyEmailBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\symfonycasts\\verify-email-bundle\\src',
                    'namespace' => 'SymfonyCasts\\Bundle\\VerifyEmail',
                ],
                'KnpPaginatorBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\knplabs\\knp-paginator-bundle',
                    'namespace' => 'Knp\\Bundle\\PaginatorBundle',
                ],
                'VichUploaderBundle' => [
                    'path' => 'D:\\pidev-user\\vendor\\vich\\uploader-bundle',
                    'namespace' => 'Vich\\UploaderBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'App_KernelDevDebugContainer',
            'images_directory' => 'D:\\pidev-user/public/uploads/images',
            ...
            'translator.default_path' => 'D:\\pidev-user/translations',
            ...
            'twig.default_path' => 'D:\\pidev-user/templates',
            ...
            'vich_uploader.mappings' => [
                'profile_images' => [
                    ...
                    'upload_destination' => 'D:\\pidev-user/public/uploads/profiles',
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.profile_images',
                        'options' => [
